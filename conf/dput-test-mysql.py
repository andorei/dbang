...
#     dput.py conf/dput-test-mysql.py all
...
specs = {
    ...
    "nested_01_keygen": {
        ...
        "encoding": "UTF-8",
        "insert_actions": [
            "insert into test_region (region_id, region, contains) values (%s, %s, %s)",
            "insert into test_countries (region_id, code, name) values (%s, %s, %s)"
        ],
        "insert_data": [
