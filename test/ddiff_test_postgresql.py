...
SOURCES = ["ONE", "TWO"]
sources["ONE"] = sources["postgresql_source"]
sources["TWO"] = sources["postgresql_source"]
DDIFF_SOURCE = sources["postgresql_source"]
...
sources['postgresql_source']['setup'] = sources['postgresql_source'].get('setup', []) + [
